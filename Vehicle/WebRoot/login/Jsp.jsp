...
<html>
  ...
  <body >
		...
		<div style="float:right;width:330px;height:335px;border: 1px solid lightblue;background-color: #F7F7F7;margin: 70px 144px;">
			<div style="border-bottom: 1px solid lightblue;height:47px;text-align: center;"><b><span>手机号登录</span></b></div>
